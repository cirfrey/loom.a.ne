...
> --------------------------------------- [89762c5:2026-03-28T23:21:13]
    ...
    */
    ...
    using banner_writer_t = void(*)(text);
    using banner_sleeper_t = void(*)();
    auto write_banner(
        banner_writer_t writer, // How to write this.
        banner_sleeper_t sleeper = nullptr, // How much to sleep for between characters. nullptr disables this feature.
        ...
        text prefix = {"\n", 1}, // Appended to the start of the banner. Useful if you want
