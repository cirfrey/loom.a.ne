...
namespace lm::config_ini
{
    ...
    inline ini::field fields[] = {
        ...
        /// --- Logging ---
        feature("logging.debug.toggle",     config_rw.logging.level_enabled[config_t::logging_t::level::debug]),
        feature("logging.test.toggle",      config_rw.logging.level_enabled[config_t::logging_t::level::test]),
        feature("logging.assertion.toggle", config_rw.logging.level_enabled[config_t::logging_t::level::assertion]),
        feature("logging.info.toggle",      config_rw.logging.level_enabled[config_t::logging_t::level::info]),
        feature("logging.regular.toggle",   config_rw.logging.level_enabled[config_t::logging_t::level::regular]),
        feature("logging.warn.toggle",      config_rw.logging.level_enabled[config_t::logging_t::level::warn]),
        feature("logging.error.toggle",     config_rw.logging.level_enabled[config_t::logging_t::level::error]),
        feature("logging.panic.toggle",     config_rw.logging.level_enabled[config_t::logging_t::level::panic]),
        string("logging.debug.ansi",       config_rw.logging.level_ansi.data[config_t::logging_t::level::debug],       {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::debug]}),
        string("logging.test.ansi",        config_rw.logging.level_ansi.data[config_t::logging_t::level::test],        {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::test]}),
        string("logging.assertion.ansi",   config_rw.logging.level_ansi.data[config_t::logging_t::level::assertion],   {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::assertion]}),
        string("logging.info.ansi",        config_rw.logging.level_ansi.data[config_t::logging_t::level::info],        {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::info]}),
        string("logging.regular.ansi",     config_rw.logging.level_ansi.data[config_t::logging_t::level::regular],     {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::regular]}),
        string("logging.warn.ansi",        config_rw.logging.level_ansi.data[config_t::logging_t::level::warn],        {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::warn]}),
        string("logging.error.ansi",       config_rw.logging.level_ansi.data[config_t::logging_t::level::error],       {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::error]}),
        string("logging.panic.ansi",       config_rw.logging.level_ansi.data[config_t::logging_t::level::panic],       {.max_len = config_t::logging_t::ansi_max_len,   .size_out = &config_rw.logging.level_ansi.size[config_t::logging_t::level::panic]}),
        string("logging.debug.prefix",     config_rw.logging.level_prefix.data[config_t::logging_t::level::debug],     {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::debug]}),
        string("logging.test.prefix",      config_rw.logging.level_prefix.data[config_t::logging_t::level::test],      {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::test]}),
        string("logging.assertion.prefix", config_rw.logging.level_prefix.data[config_t::logging_t::level::assertion], {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::assertion]}),
        string("logging.info.prefix",      config_rw.logging.level_prefix.data[config_t::logging_t::level::info],      {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::info]}),
        string("logging.regular.prefix",   config_rw.logging.level_prefix.data[config_t::logging_t::level::regular],   {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::regular]}),
        string("logging.warn.prefix",      config_rw.logging.level_prefix.data[config_t::logging_t::level::warn],      {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::warn]}),
        string("logging.error.prefix",     config_rw.logging.level_prefix.data[config_t::logging_t::level::error],     {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::error]}),
        string("logging.panic.prefix",     config_rw.logging.level_prefix.data[config_t::logging_t::level::panic],     {.max_len = config_t::logging_t::prefix_max_len, .size_out = &config_rw.logging.level_prefix.size[config_t::logging_t::level::panic]}),
