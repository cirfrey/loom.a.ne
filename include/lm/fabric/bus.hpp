...
namespace lm::fabric::bus
{
    ...
    auto subscribe(lm::fabric::queue_t& queue, st topic, std::initializer_list<u8> types = {}) -> subscribe_token;
    ...
    struct publish_result
    {
        ...
        st filtered  = 0; // How many subscribers are interested in this topic but not this event specifically.
