...
namespace lm::strands
{
    ...
    struct blink
    {
        blink(fabric::strand_runtime_info& info);
...
template <lm::u16 MPS>
auto lm::strands::blink_pattern<MPS>::tick(u32 dt_micros) -> u32
{
...
template <lm::u16 MPS>
lm::strands::blink_pattern<MPS>::blink_pattern(type_t repeats, const char* _pattern, u32 interval)
{
...
template <lm::u16 MPS>
lm::strands::blink_pattern<MPS>::blink_pattern(u32 num_repeats, const char* _pattern, u32 interval)
...
template <lm::u16 MPS>
auto lm::strands::blink_pattern<MPS>::is_done() -> bool
{
...
template <lm::u16 MPS>
auto lm::strands::blink_pattern<MPS>::state() -> bool
{
