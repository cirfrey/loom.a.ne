...
namespace lm::renum::detail
{
    ...
    consteval auto enum_value_view()
    {
            ...
            std::string_view prefix = "auto __cdecl lm::renum::detail::enum_value_view<";
...
namespace lm::renum
{
    ...
    struct reflected
    {
        ...
        static constexpr auto qualified(Enum const& e)      -> std::string_view { return operator[](e).qualified(); }
        static constexpr auto unqualified(Enum const& e)    -> std::string_view { return operator[](e).unqualified(); }
        static constexpr auto semi_qualified(Enum const& e) -> std::string_view { return operator[](e).semi_qualified(); }
