...
auto lm::strands::log::capacity() -> st
{
    st ret = 0;
    logging::logbuf.read([&](auto& buf){
...
auto lm::strands::log::occupancy() -> st
{
    st ret = 0;
    logging::logbuf.read([&](auto& buf){
...
auto lm::strands::logging::consumer::mark_as_done() -> status
{
    offset        = 0;
    total_chunks  = 0;
    failed_chunks = 0;
...
auto lm::strands::logging::consumer::consume(buf b) -> status
{
...
auto lm::strands::logging::consumer::flush() -> void
{
    /// TODO:
}
